...
import type { AssetWork, BoatAssetDetail, DocumentPurpose } from '../../../../../domain/boat-assets'
  ...
  return (
    <main className="page-wrap px-3 pb-24 pt-4 sm:px-4">
      ...
      <header className="mb-6">
        ...
        {asset.description ? (
          <p className="mt-3 text-sm text-[var(--sea-ink-soft)]">{asset.description}</p>
        ) : null}
      </header>
      ...
      <section className="mb-8">
        ...
        {asset.documents.length === 0 && !uploading ? (
          <p className="mb-3 text-sm text-[var(--sea-ink-soft)]">
            No documents yet. Upload a receipt, add a file, or paste a link below.
          </p>
        ) : null}
