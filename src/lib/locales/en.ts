...
const catalog: TranslationCatalog = {
  ...
  logEntry: 'Log entry',
  tripChat_showMap: 'Show map',
  tripChat_hideMap: 'Hide map',
  fitRoute: 'Fit route',
  ...
  invite: 'Invite',
  inviteEmailLanguage: 'Invitation language',
  inviteEmailLanguageHint: 'The invite email will be sent in this language.',
