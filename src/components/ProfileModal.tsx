...
import { fetchNotificationDefaults, updateNotificationDefaults } from "../lib/notifications-api";
    ...
    <Modal title="Profile" onClose={handleClose} devComponentName="ProfileModal">
      <form onSubmit={(e) => void handleSaveName(e)} className="space-y-5">
        <div className="flex items-center gap-4">
          <div className="relative shrink-0">
            <div className="flex size-20 items-center justify-center overflow-hidden rounded-2xl border border-[var(--line)] bg-[var(--chip-bg)]">
              {photoSrc ? (
                <img src={photoSrc} alt="" className="size-full object-cover" width={80} height={80} decoding="async" />
              ) : (
          ...
          <div className="min-w-0">
            <p className="m-0 text-sm font-semibold text-[var(--sea-ink)]">Profile photo</p>
        ...
        <label className="block">
          <span className="mb-1.5 block text-sm font-medium text-[var(--sea-ink)]">Display name</span>
          <input
            value={name}
        ...
        <p className="m-0 text-xs leading-6 text-[var(--sea-ink-soft)]">Signed in as {user.email}</p>

        <div className="rounded-2xl border border-[var(--line)] bg-[var(--chip-bg)] px-4 py-3">
          <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
            <p className="m-0 text-sm font-semibold text-[var(--sea-ink)]">Notification defaults</p>
            <Link
            ...
            <button
              ...
              onClick={() => {
                ...
                void updateNotificationDefaults({
                  ...
                  .catch((e) => toast.error(e instanceof Error ? e.message : "Failed to save defaults"))
            ...
            <button
              ...
              onClick={() => {
                ...
                void enablePushOnDevice()
                  .catch((e) => toast.error(e instanceof Error ? e.message : "Failed to enable push"))
