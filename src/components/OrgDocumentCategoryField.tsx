...
import type { OrgDocumentCategory } from '../domain/org'
import { createOrgDocumentCategory } from '../lib/org-documents-api'

const ADD_CATEGORY_VALUE = '__add_category__'

type OrgDocumentCategoryFieldProps = {
...
export function OrgDocumentCategoryField({
  categories,
  value,
  onChange,
  onCategoryCreated,
  ...
  const handleCreateCategory = async () => {
    ...
    setBusy(true)
    try {
      const category = await createOrgDocumentCategory(orgId, name)
