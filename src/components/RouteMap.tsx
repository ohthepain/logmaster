...
export const RouteMap = forwardRef<TripMapHandle, RouteMapProps>(
  function RouteMapView(
    ...
    const aisEnabled = resolveMapDataLayerToggle(
      mapDataLayerToggles,
      'ais-live',
    )
    ...
    const lineGeoJson = useMemo(
      () => buildRouteLineGeoJson(waypoints),
      [waypoints],
    )
        ...
        >
          ...
          {showControls && !waypointMapInteractionActive ? (
            <SailingMapControlStack
              ...
              onExpand={
                allowFullscreen ? () => setMapFullscreenOpen(true) : undefined
              }
            />
          ) : null}
