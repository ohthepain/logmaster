        ...
        {trip.status === 'PLANNED' && !waypointMapInteractionActive ? (
          ...
          >
            <button
              ...
              data-map-touch-zone
              className="ios-map-touch-target pointer-events-auto inline-flex items-center justify-center gap-2 rounded-full bg-btn-bg px-5 py-3 text-base font-bold text-btn-text shadow-lg transition hover:-translate-y-px disabled:opacity-60"
            >
